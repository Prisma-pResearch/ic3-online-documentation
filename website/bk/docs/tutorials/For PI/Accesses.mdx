...
Currently, IC<sup>3</sup> has **4** HiPerGator groups. 3 of them are built for PrismaP teams while the other one is for IC<sup>3</sup> educational purposes.
:::

To get the details about HiPerGator, please refer to [HiPerGator Workspace](../../workspaces/HiPerGator.md)
