...
<summary> Example Model Card created by InstructGPT</summary>
...
We release samples from our models on public NLP datasets that require sampling [here](https://github.com/openai/following-instructions-human-feedback/tree/main/automatic-eval-samples).
